...
class _$_UserEntity implements _UserEntity {
  ...
  @override
  String toString() {
    return 'UserEntity(email: $email, login: $login, id: $id, accessToken: $accessToken, refreshToken: $refreshToken)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, email, login, id, accessToken, refreshToken);
