...
class CommentApi {
  ...
  CommentApi([ApiClient? apiClient])
      : apiClient = apiClient ?? defaultApiClient;

  ///
  ///
  ///
  Future<Comment> createComment(Comment body) async {
    ...
    if (response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Comment') as Comment;
    } else {
      return Comment();
    }
  }
  ...
  Future<List<Comment>> getComments(
    ...
    if (response.statusCode >= 400) {
      ...
      return (apiClient.deserialize(response.body, 'List<Comment>') as List)
          .map((item) => item as Comment)
          .toList();
    } else {
      return [];
    }
  ...
  ///
  ///
  Future<Comment> updateComment(Comment body, String id) async {
    Object postBody = body;
