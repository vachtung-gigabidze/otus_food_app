...
void main() {
  testWidgets("Виджет-тест для шагов приготовления рецепта",
      (widgetTester) async {
    final Recipe fakeRecipe = Recipe.fromJson(json.decode(
    ...
    final RecipeStepLink stubRecipeStepLink = fakeRecipe.recipeStepLinks![0];

    await widgetTester.pumpWidget(_wrap(CookingStepCard(
